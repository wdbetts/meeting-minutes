...
class DatabaseManager:
    ...
    def _legacy_init_db(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            try:
                ...
                logger.info("Added speaker column to transcripts table")
            except sqlite3.OperationalError:
                pass  # Column already exists
    ...
    async def save_meeting_transcript(self, meeting_id: str, transcript: str, timestamp: str,
        ...
        """Save a transcript for a meeting with optional recording-relative timestamps and speaker attribution"""
        try:
            with sqlite3.connect(self.db_path) as conn:
                cursor = conn.cursor()

                # Save transcript with timestamp fields for playback sync and speaker attribution
                cursor.execute("""
    ...
    async def get_meeting(self, meeting_id: str):
        ...
        try:
            async with self._get_connection() as conn:
                ...
                # Get all transcripts for this meeting with timestamp fields and speaker attribution
                cursor = await conn.execute("""
                ...
                return {
                    ...
                    'transcripts': [{
                        ...
                        # Speaker attribution: "Me" or "Them"
